...
/// <summary>
/// Extracts identifier tokens from type signatures for efficient type-reference lookups.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Extracts all identifier tokens from <paramref name="signature"/> and adds them to <paramref name="tokens"/>.
    /// </summary>
