...
// Package sdk demonstrates scenarios where source-based extraction fails.
//
// SOURCE LIMITATION: The go/parser-based extractor parses syntax trees without
...
//
// COMPILED: The go/packages-based extractor runs the full Go type checker,
...
//
// SOURCE LIMITATION: The source parser extracts the type parameter syntax
