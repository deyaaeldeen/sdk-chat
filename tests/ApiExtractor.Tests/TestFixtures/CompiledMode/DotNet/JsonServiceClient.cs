...
/// The source-parsing extractor cannot resolve these types because it doesn't load
/// the System.Text.Json assembly — they appear as TypeKind.Error and get silently dropped.
/// The compiled extractor loads the DLL where all references are resolved.
/// </summary>
public class JsonServiceClient
{
    /// <summary>Gets the serializer options.</summary>
    /// <remarks>
    /// SOURCE LIMITATION: The source extractor sees "JsonSerializerOptions" as a raw string.
    ...
    /// semantically verified — the extractor doesn't know IJsonModel's assembly.
    ...
    /// SOURCE LIMITATION: The source extractor cannot determine JsonElement is a struct 
...
/// SOURCE LIMITATION: The source extractor sees [JsonPropertyName] and [JsonIgnore]
...
/// SOURCE LIMITATION: The source extractor uses the "I" prefix convention to guess
...
/// the extractor may not resolve T to the correct type parameter.
