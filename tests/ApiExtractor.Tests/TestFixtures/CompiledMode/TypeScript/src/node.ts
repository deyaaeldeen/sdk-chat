 ...
 *
 * SOURCE LIMITATION: The source extractor sees this file as part of the same module.
...
export class NodeClient extends BaseClient {
   ...
   * SOURCE LIMITATION: The source extractor includes this method in the unified API.
   ...
   * Same limitation: source extractor cannot distinguish per-target availability.
   */
