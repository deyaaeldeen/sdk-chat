 ...
 *
 * SOURCE LIMITATION: The source extractor sees this alongside the node implementation.
...
export class BrowserClient extends BaseClient {
   ...
   * SOURCE LIMITATION: The source extractor includes this in the unified API.
