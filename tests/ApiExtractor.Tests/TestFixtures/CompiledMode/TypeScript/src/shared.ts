 ...
 *
 * SOURCE LIMITATION: The source extractor processes this file directly and sees
 ...
 * extractor cannot resolve the import or track the dependency.
...
// The source extractor sees the import but can't follow it to node_modules.
...
export abstract class BaseClient {
   ...
   * Without the package installed, the source extractor cannot attribute
