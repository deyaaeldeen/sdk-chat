...
public class GetReferencedTypesTests
{
    ...
    #region DotNet BuildDependencyGraph Tests

    [Fact]
    public void DotNet_BuildDependencyGraph_NoSubstringFalsePositives()
    {
                ...
                new DotNetModels.NamespaceInfo
                {
                    ...
                    [
                        new DotNetModels.TypeInfo
                        {
                            ...
                            Members =
                            [
                                new DotNetModels.MemberInfo
                                {
                                    Name = "SetPolicy",
                                    Kind = "method",
                                    Signature = "void SetPolicy(PolicyList list)"
                                }
                            ]
                        },
                        new DotNetModels.TypeInfo
        ...
        Assert.Contains("PolicyList", graph["PolicyClient"]);
        Assert.DoesNotContain("Policy", graph["PolicyClient"]);
        Assert.Contains("Policy", graph["PolicyList"]);
    }

    [Fact]
    public void DotNet_BuildDependencyGraph_IncludesBaseAndInterfaces()
    {
        var api = new DotNetModels.ApiIndex
        {
            Package = "Test.Sdk",
                        ...
                        new DotNetModels.TypeInfo
                        {
                            ...
                            [
                                new DotNetModels.MemberInfo
                                {
                                    Name = "SendAsync",
                                    Kind = "method",
                                    Signature = "Task<ChatResponse> SendAsync(ChatRequest request)"
                                }
                            ]
                        },
                        new DotNetModels.TypeInfo { Name = "ServiceClient", Kind = "class" },
                        new DotNetModels.TypeInfo { Name = "IDisposable", Kind = "interface" },
                        new DotNetModels.TypeInfo { Name = "ChatResponse", Kind = "class" },
                        new DotNetModels.TypeInfo { Name = "ChatRequest", Kind = "class" }
                    ]
                }
            ]
        };
        ...
        Assert.Contains("ServiceClient", graph["ChatClient"]);
        Assert.Contains("IDisposable", graph["ChatClient"]);
        Assert.Contains("ChatResponse", graph["ChatClient"]);
        Assert.Contains("ChatRequest", graph["ChatClient"]);
    }

    [Fact]
    public void DotNet_BuildDependencyGraph_ExcludesUnknownTypes()
    {
        var api = new DotNetModels.ApiIndex
        {
            Package = "Test.Sdk",
                        ...
                        new DotNetModels.TypeInfo
                        {
                            ...
                            [
                                new DotNetModels.MemberInfo
                                {
                                    Name = "Process",
                                    Kind = "method",
                                    Signature = "Task<string> Process(CancellationToken token)"
                                }
                            ]
                        }
                    ]
